...
public class DBConnection {
    private static final String URL = "jdbc:mysql://localhost:3306/KungFu?serverTimezone=UTC&useSSL=false";
    ...
    public static Connection getConnection() throws SQLException {
        ...
        try {
            ...
            System.out.println(" Conexion exitosa a la base de datos KungFu");
            return conn;
